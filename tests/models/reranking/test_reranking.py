...
def main(model_path: str, dataset_path: str, encodings_path: str, features_path: str, playlists_path: str, test_playlists_path: str, uris_dict_filepath:str, desired_distribution_filepath: str, report_path: str):
    ...
    for test_playlist in tqdm(test_playlists[:2, :], total=test_playlists[:2, :].shape[0]):
        ...
        reranked_recommended = recommendation_reranking_component(uris_dict_filepath, desired_distribution_filepath, recommended_tracks)
        ground_truths.append(test)
        predictions.append(reranked_recommended)
