...
def diversify_component(features: NDArray, playlists: NDArray, user_playlist: NDArray, n: Optional[int] = 10, sample_size: Optional[int] = 5, hid_dim: Optional[int] = 16, epochs: Optional[int] = 100):
    ...
    predictions, model, predictor, hidden_dim = recommend_n_diverse(
        features, playlists, user_playlist, n, sample_size, hid_dim, epochs)
...
def rank_and_diversify_component(features: NDArray, playlists: NDArray, user_playlist: NDArray, ranking_n: Optional[int] = 100, ranking_epochs: Optional[int] = 1,  diversify_n: Optional[int] = 10, diversify_sample_size: Optional[int] = 5, diversify_hid_dim: Optional[int] = 16, diversify_epochs: Optional[int] = 100):
    relevant_playlists, features, user_playlist, recommended_tracks, recommended_ids = ranking_component(
        features, playlists, user_playlist, ranking_n, ranking_epochs)
    additional_recommendations = diversify_component(
        features, relevant_playlists, user_playlist, diversify_n, diversify_sample_size, diversify_hid_dim, diversify_epochs)
    ...
    # modify recommended_tracks
    return relevant_playlists, features, user_playlist, recommendations
